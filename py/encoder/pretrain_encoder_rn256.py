...
def train_autoencoder_with_metrics(img_dir, epochs=10, batch_size=128, lr=1e-3, img_size=120, num_imgs=1000, device='cuda'):
    ...
    sample_dir = os.path.join(os.path.dirname(__file__), "rn256")
    ...
    torch.save(model.encoder.state_dict(), "encoder_rn256.pth")
    ...
    print("Loss, SSIM, MAE, PSNR, and epoch times saved to metrics_rn256.npz")
